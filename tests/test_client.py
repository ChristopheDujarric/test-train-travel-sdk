...
from test_train_travel_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: TestTrainTravelSDK | AsyncTestTrainTravelSDK) -> int:
...
class TestTestTrainTravelSDK:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "test_train_travel_sdk/_legacy_response.py",
                        "test_train_travel_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "test_train_travel_sdk/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: TestTrainTravelSDK) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(TEST_TRAIN_TRAVEL_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = TestTrainTravelSDK(
    ...
    def test_base_url_trailing_slash(self, client: TestTrainTravelSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: TestTrainTravelSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: TestTrainTravelSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = TestTrainTravelSDK(
            base_url=base_url, client_id=client_id, client_secret=client_secret, _strict_response_validation=True
        )
    ...
    @mock.patch("test_train_travel_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/bookings").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/bookings").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/bookings").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: TestTrainTravelSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.bookings.with_raw_response.create(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.bookings.with_raw_response.create(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncTestTrainTravelSDK:
    client = AsyncTestTrainTravelSDK(
        base_url=base_url, client_id=client_id, client_secret=client_secret, _strict_response_validation=True
    )
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncTestTrainTravelSDK(
            base_url=base_url,
            client_id=client_id,
            client_secret=client_secret,
            _strict_response_validation=True,
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTestTrainTravelSDK) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncTestTrainTravelSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTestTrainTravelSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTestTrainTravelSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTestTrainTravelSDK(
            base_url=base_url, client_id=client_id, client_secret=client_secret, _strict_response_validation=True
        )
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncTestTrainTravelSDK,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.bookings.with_raw_response.create()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTestTrainTravelSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.bookings.with_raw_response.create(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.bookings.with_raw_response.create(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from test_train_travel_sdk._utils import asyncify
        from test_train_travel_sdk._base_client import get_platform 
